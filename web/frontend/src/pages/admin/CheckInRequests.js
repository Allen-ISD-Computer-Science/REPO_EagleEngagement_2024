...
import ApprovalCarousel from "../../components/CheckInCarousel";

function CheckInRequestsPage(props) {

  return (
    <div className="flex flex-row items-stretch min-h-[100vh]">
      <AdminNav selected="check-ins" />
...
export default CheckInRequestsPage;